/*
  # Service Order System Update
  
  1. New Tables
    - `service_order_equipment_items` - Stores multiple equipment entries per service order
    - `service_order_history` - Tracks changes to service orders
    
  2. Changes
    - Added auto-incrementing ID to service orders
    - Added last_modified timestamp
    - Added equipment items relationship
...
-- Create sequence for service order numbers
