...
export function Layout({ children }: LayoutProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      children: [
        { label: 'Balcão', icon: <Receipt className="w-5 h-5" />, path: '/sales/counter' },
        { label: 'Aparelhos', icon: <Smartphone className="w-5 h-5" />, path: '/sales/devices' },
        { label: 'Produtos', icon: <Box className="w-5 h-5" />, path: '/sales/products' },
        { label: 'Serviços', icon: <Wrench className="w-5 h-5" />, path: '/sales/services' }
      ]
    },
    {
      label: 'Financeiro',
